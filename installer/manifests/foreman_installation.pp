...
file { '/opt/foreman/config/settings.yaml':
  ...
  source  => '/opt/opstheater/installer/files/foreman/settings.yaml',
  require => [ Vcsrepo['/opt/foreman'], Postgresql::Server::Db['foreman'] ],
}

file { '/opt/foreman/config/database.yml':
  ensure  => file,
  source  => '/opt/opstheater/installer/files/foreman/database.yml',
  require => [ Vcsrepo['/opt/foreman'], Postgresql::Server::Db['foreman'] ],
}
...
file { '/opt/foreman/config/settings.plugins.d/default_hostgroup.yaml':
  ...
  source  => '/opt/opstheater/installer/files/foreman/default_hostgroup.yaml',
  require => [ Vcsrepo['/opt/foreman'], Postgresql::Server::Db['foreman'] ],
}
...
file { '/opt/smart-proxy/config/settings.yml':
  ...
  source  => '/opt/opstheater/installer/files/smart-proxy/settings.yml',
  require => Vcsrepo['/opt/smart-proxy'],
}

file { '/opt/smart-proxy/config/settings.d/puppet.yml':
  ensure  => file,
  source  => '/opt/opstheater/installer/files/smart-proxy/puppet.yml',
  require => Vcsrepo['/opt/smart-proxy'],
}

file { '/opt/smart-proxy/config/settings.d/puppetca.yml':
  ensure  => file,
  source  => '/opt/opstheater/installer/files/smart-proxy/puppetca.yml',
  require => Vcsrepo['/opt/smart-proxy'],
}

file { '/etc/puppetlabs/puppet/foreman.yaml':
  ensure => file,
  source => '/opt/opstheater/installer/files/foreman/foreman.yaml',
}

file { '/opt/puppetlabs/puppet/lib/ruby/vendor_ruby/puppet/reports/foreman.rb':
  ensure => file,
  source => '/opt/opstheater/installer/files/foreman/foreman.rb',
}

file { '/etc/puppetlabs/puppet/node.rb':
  ensure => file,
  mode   => '0755',
  source => '/opt/opstheater/installer/files/foreman/node.rb',
}
